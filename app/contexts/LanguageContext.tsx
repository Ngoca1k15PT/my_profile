...
const translationsMap = {
  en: {
    ...
    "hero.description": "Building high-quality mobile apps with {performance}, {scalability}, and {ux} in mind. Nearly 4 years of crafting real-world mobile experiences.",
    ...
    "about.p2": "Over the past 4 years, I've focused on {rn} because it lets me build beautiful, high-performance apps for both iOS and Android without compromise.",
  ...
  vi: {
    ...
    "hero.description": "Xây dựng các ứng dụng di động chất lượng cao với {performance}, {scalability} và {ux} trong tâm trí. Gần 4 năm tạo ra các trải nghiệm mobile thực tế.",
    ...
    "about.p2": "Trong 4 năm qua, tôi tập trung vào {rn} vì nó cho phép tôi xây dựng các ứng dụng đẹp, hiệu suất cao cho cả iOS và Android mà không cần thỏa hiệp.",
    "about.p2.rn": "React Native",
